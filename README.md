...
### Step 2
- In the terminal, change your directory to the location of the repository you cloned by entering ```cd ~/path/to/kyoushitsu-b``` on MacOS/Linux, or ```cd C:\path\to\kyoushitsu-b``` on Windows.
